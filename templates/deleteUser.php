 ...
 <div class="modal fade modal-lg" id="deleteUser" tabindex="-1" aria-labelledby="deleteUserModal" aria-hidden="true">
   <div class="modal-dialog modal-xl modal-dialog-centered">
     <div class="modal-content">
       <div class="modal-header">
         <h1 class="modal-title fs-5" id="deleteUserModal">Eliminar usuario</h1>
           ...
           <div class="container bg-8 text-center">
             <div class="panel panel-primary">
               ...
               <h4>
                 <br>
                 ¿Quieres eliminar a:
                 <?php echo "$user->userName $user->userLastName?"; ?>
               </h4>
               <br>
             </div>
           </div>
